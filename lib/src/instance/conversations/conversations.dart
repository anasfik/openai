...
class OpenAIConversations extends OpenAIConversationsBase {
  ...
  Future<OpenAIConversation> create({
    ...
    return OpenAINetworkingClient.post<OpenAIConversation>(
  ...
  Future<OpenAIConversation> get({
    ...
    return OpenAINetworkingClient.get<OpenAIConversation>(
  ...
  Future<OpenAIConversationItemsResponse> listItems({
    ...
    return OpenAINetworkingClient.get<OpenAIConversationItemsResponse>(
  ...
  Future<OpenAIConversationItemsResponse> createItems({
    ...
    return OpenAINetworkingClient.post<OpenAIConversationItemsResponse>(
