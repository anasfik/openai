...
class OpenAIVectorStoreFiles extends OpenAIVectorStoreFilesBase {
  ...
  Future<OpenAIVectorStoreFileModel> create({
    ...
    return OpenAINetworkingClient.post<OpenAIVectorStoreFileModel>(
        to: BaseApiUrlBuilder.buildFor(
            _config, endpoint, '$vectorStoreId/files'),
        body: {
          'file_id': fileId,
  ...
  Future<OpenAIVectorStoreFileModel> get({
    ...
    return OpenAINetworkingClient.get<OpenAIVectorStoreFileModel>(
        from: BaseApiUrlBuilder.buildFor(
            _config, endpoint, '$vectorStoreId/files/$fileId'),
        onSuccess: (Map<String, dynamic> response) {
          return OpenAIVectorStoreFileModel.fromMap(response);
        },
        config: _config);
  ...
  Future<OpenAIVectorStoreFileListModel> list({
    ...
    return OpenAINetworkingClient.get<OpenAIVectorStoreFileListModel>(
  ...
  Future getContent({
    ...
    return OpenAINetworkingClient.get(
      from: BaseApiUrlBuilder.buildFor(
          _config, endpoint, '$vectorStoreId/files/$fileId/content'),
